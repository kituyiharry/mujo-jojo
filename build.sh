...
cp -rv ../../../mujoco/build/lib/lib* ./target/release/;
cp -rv ../../../mujoco/build/lib/lib* ./target/debug/;
cp -rv ../../../mujoco/build/lib/lib* ./mujoco-sys/examples/mujo-jojo/target/release/;
cp -rv ../../../mujoco/build/lib/lib* ./mujoco-sys/examples/mujo-jojo/target/debug/;
